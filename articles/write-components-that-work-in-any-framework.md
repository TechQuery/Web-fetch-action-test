...
Here are some of the reusable components from my library [A2K][1]. You can see that they come in all shapes and sizes, and have a range of different functionalities. Using them in your projects is similar to using any old HTML element.
...
I recently created a web component that renders a CodeSandbox code editor in the browser. And because it’s a web component, you can use it in any framework you like! If you’d like to learn a little more about that, [you can read more here][2].
...
There’s a lot more nuance when it comes to the Shadow DOM, as well as other features that we’re not going to touch on in this article. If you’d like to learn more about web components though, I have an entire course ([Component Odyssey][3]) dedicated to teaching you how to build reusable components that work in any framework.
...
One such tool is called Lit, which is developed by a team at Google. [Lit][4] is a lightweight library designed to make writing web components simple, by removing the need for the boilerplate we’ve already seen above.
...
If you’d like to learn even more, this is the approach I teach in my upcoming course [Component Odyssey][5]. This course is excellent for anyone who wants to understand how to write components that work in any framework.
...
If you want early-bird discount codes for Component Odyssey, then head on [over to the site to get notified][6].
...
[1]: https://a2000-docs.netlify.app/
[2]: https://component-odyssey.com/articles/00-sandpack-lit-universal
[3]: https://component-odyssey.com/
[4]: https://lit.dev/
[5]: https://component-odyssey.com/
[6]: https://component-odyssey.com/subscribe
[7]: /news/author/andrico/
